...
# Make sure we add Heart to imports
if 'Heart' not in content[:1000]:
    content = re.sub(r'(import \{.*?)(\} from "lucide-react";)', r'\1, Heart\2', content)

new_snacks = '''// --- Snacks Data & Component ---
const SNACK_ITEMS = [
  {
    id: "snack_alu_bhujia",
...
# Replace the block
content = re.sub(r'// --- Snacks Data & Component ---.*?};', new_snacks, content, flags=re.DOTALL)
